...
function MainContent() {
    ...
    return (
        <div className={(desktop ? 'MainContent' : 'MainContent desktop')}>
            ...
            <img className={(desktop ? 'storyImage' : 'storyImageDesktop')} src="\src\assets\crabsign-w.jpg" />
                <p>
            ...
            <div className={(desktop ? 'story' : 'storyDesktop')}>
            <img className={(desktop ? 'storyImage' : 'storyImageDesktop')} src="\src\assets\food3-s.jpg" />
                <p>
            ...
            <div className={(desktop ? 'story' : 'storyDesktop')}>
            <img className={(desktop ? 'storyImage' : 'storyImageDesktop')} src="\src\assets\food1-w.jpg" />
                <p>
            ...
            <div className={(desktop ? 'story' : 'storyDesktop')}>
            <img className={(desktop ? 'storyImage' : 'storyImageDesktop')} src="\src\assets\naradeer-s.jpg" />
                <p>
            ...
            <div className={(desktop ? 'story' : 'storyDesktop')}>
            <img className={(desktop ? 'storyImage' : 'storyImageDesktop')} src="\src\assets\food6-w.jpg" />
                <p>
